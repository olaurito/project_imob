                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12">
                                ...
                                <select class="selectpicker input-large" id="type" name="filter_type" multiple
                                    ...
                                    data-action="{{ route('component.main-filter.type') }} " title="Escolha...">
                                    <option disabled>Selecione o filtro anterior</option>
                                </select>
                            </div>
                                        ...
                                        <div class="card-footer d-flex">
                                            ...
                                            <div class="main_properties_features col-4 text-center">
                                                <img src="{{asset('frontend/assets/images/icons/garage.png')}}" class="img-fluid"
                                                    alt="">
                                                <p class="text-muted">
                                                    {{ $property->garage + $property->garage_covered }}</p>
                                            </div>

                                            <div class="main_properties_features col-4 text-center">
                                                <img src="{{asset('frontend/assets/images/icons/util-area.png')}}" class="img-fluid"
                                                    alt="">
