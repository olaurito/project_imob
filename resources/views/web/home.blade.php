            ...
            <div class="row">
                <form action="{{route('web.filter')}}" method="post" class="form-inline w-100">
                    ...
                    <div class="form-group col-12 col-sm-6 mt-sm-2 mt col-lg-3 mt-lg-0">
                        ...
                        <select class="selectpicker input-large" id="type" name="filter_type" multiple data-actions-box="true" data-index="3" data-action="{{route('component.main-filter.type')}}" title="Escolha...">
                            <option disabled>Selecione o filtro anterior</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 mt-3 form_advanced" style="display: none;">
                        ...
                        <div class="row">
                            <div class="form-group col-12 col-sm-6 mt-sm-2 col-lg-3 mt-lg-0">
                                ...
                                <select class="selectpicker" name="filter_bedrooms" id="bedrooms" data-index="5" data-action="{{route('component.main-filter.bedrooms')}}" title="Escolha...">
                                    <option disabled>Selecione o filtro anterior</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-12 col-sm-6 mt-sm-2 col-lg-3 mt-lg-0">
                                ...
                                <select class="selectpicker" name="filter_suites" id="suites" data-index="6" data-action="{{route('component.main-filter.suites')}}" title="Escolha..." >
                                    <option disabled>Selecione o filtro anterior</option>
                                </select>
                            </div>
