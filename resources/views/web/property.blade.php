    ...
    <section class="main_property">
        <div class="main_property_header py-5 bg-light">
            <div class="container">
                ...
                <p class="mb-0">{{ $property->category }} - {{ $property->type }} -
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div id="carouselProperty" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                @if($property->images()->get()->count())
                                    ...
                                    <div class="carousel-item {{ ($loop->iteration == 1 ? 'class="active"' : '') }} ">
                        ...
                        <div class="main_property_price pt-4 text-muted">IPTU: R$ {{$property->tribute}} {{ ($property->condominium != '0,00' ? '| Condomínio: R$ ' . $property->condominium : '') }} </p>

                            @if (!empty($type) && $type == 'sale')
                            <p class="main_property_price_big">Valor do Imóvel: {{$property->sale_price}}</p>

                        @elseif(!empty($type) && $type == 'rent')
                        <p class="main_property_price_big">Valor do Aluguel: {{$property->rent_price}}/mês</p>
                        ...
                        @else
                            ...
                            @else
                                <p class="main_properties_price text-front">
                                    Entre emc contato com a nossa equipe comercial!</p>
                            @endif
                        @endif
                        </div>
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <div class="main_property_share py-3 text-right d-flex justify-content-center">
                           ...
                           {{--  <button class="btn btn-front icon-facebook icon-notext"></button> --}}
                            ...
                            <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button " data-size="large" data-text="{{$property->title}}" data-url="{{url()->current()}}" data-hashtags="laradev" data-related="otirualo" data-lang="pt" data-show-count="false">Tweet</a>

                            <a href="http://instagram.com" target="_blank" class="btn btn-front icon-instagram ml-2" style="padding: 0 10px; margin:0; font-size:0.875em; paddin-top:2px; ">Instagram</a>
                        </div>
                    </div>
                </div>
            </div>
...
@section('js')
    ...
    <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v14.0&appId=798635354447637&autoLogAppEvents=1" nonce="ZBX7s8GW"></script>
