                            ...
                            @foreach($properties as $property)
                                <div class="realty_list_item mb-2">
                                    ...
                                    <div class="realty_list_item_actions">
                                        ...
                                        <div>
                                            @if($property->sale == true && !empty($property->sale_price))
                                            <a href="{{ route('web.buyProperty', ['slug' => $property->slug ]) }}" class="btn btn-blue icon-eye">Visualizar Imóvel (Compra)</a>
                                            @endif

                                            @if($property->rent == true && !empty($property->rent_price))
                                            <a href="{{ route('web.rentProperty', ['slug' => $property->slug ]) }}" class="btn btn-blue icon-eye">Visualizar Imóvel (Locação)</a>
                                            @endif
