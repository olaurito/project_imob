...
class User extends FormRequest
{
    ...
    /* tratanto o document antes de chegar nas regras; */
    public function all($keys = null)
    {
        return $this->validateFields(parent::all());
    }

     /*     informar os parents para o validade do tipo array, o input que tiver a posição document, retirando os pontos para pesquisar no banco */
